...
class Store(models.Model):
    ...
    location_lat = models.DecimalField(max_digits=18, decimal_places=15, null=True, blank=True)
    location_lng = models.DecimalField(max_digits=18, decimal_places=15, null=True, blank=True)
